...
class Api {
  ...
  static String popular = '$publicDomainURL/top.atom';//TODO:what is atom
  static String recent = '$publicDomainURL/recent.atom';
  static String awards = '$publicDomainURL/awards.atom';//awards =الجوائز
  static String noteworthy = '$publicDomainURL/homepage_selection.atom';//noteworthy=جدير بالملاحظة
